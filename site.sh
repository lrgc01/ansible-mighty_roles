...
ansible-playbook -i dockersrv --extra-vars "gather_y_n=false update_cache_y_n=yes basedir=${BASEDIR} confdir=${CONFDIR} sshconf=${SSHCONF}" --tags 'my_debug' Dockers.yml 
